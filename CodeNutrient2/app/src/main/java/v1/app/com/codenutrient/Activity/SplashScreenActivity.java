...
public class SplashScreenActivity extends Activity {
    ...
    /* renamed from: v1.app.com.codenutrient.Activity.SplashScreenActivity.1 */
    class C03191 extends TimerTask {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public final /* synthetic */ SplashScreenActivity this$0;

        C03191(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[0]).hashCode()) {
                case 1473929727:
                    this((SplashScreenActivity) objArr[1]);
                case 1914060689:
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[0], Integer.valueOf(((String) objArr[0]).hashCode()), "v1/app/com/codenutrient/Activity/SplashScreenActivity$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C03191 c03191, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                    return super.toString();
                case -1929064749:
                    return new Long(super.scheduledExecutionTime());
                case -1600833221:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "v1/app/com/codenutrient/Activity/SplashScreenActivity$1"}));
            }
        }
        ...
        public C03191(SplashScreenActivity this$0) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            if (incrementalChange != null) {
                Object[] objArr = new Object[]{objArr, this$0};
                this$0 = objArr[1];
                this((Object[]) incrementalChange.access$dispatch("init$args.([Ljava/lang/Object;Lv1/app/com/codenutrient/Activity/SplashScreenActivity;)Ljava/lang/Object;", objArr), null);
            }
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lv1/app/com/codenutrient/Activity/SplashScreenActivity$1;Lv1/app/com/codenutrient/Activity/SplashScreenActivity;)V", this, this$0);
            }
        }
    }

    SplashScreenActivity(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[0]).hashCode()) {
            case -1230767868:
            case 1641134334:
                this();
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[0], Integer.valueOf(((String) objArr[0]).hashCode()), "v1/app/com/codenutrient/Activity/SplashScreenActivity"}));
        }
    }

    public static /* synthetic */ Object access$super(SplashScreenActivity splashScreenActivity, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "v1/app/com/codenutrient/Activity/SplashScreenActivity"}));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0321R.layout.splash_screen);
        new Timer().schedule(new C03191(this), SPLASH_SCREEN_DELAY);
    }
    ...
    public SplashScreenActivity() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lv1/app/com/codenutrient/Activity/SplashScreenActivity;)V", this);
        }
    }
}

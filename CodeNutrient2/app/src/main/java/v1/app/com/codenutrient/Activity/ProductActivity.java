...
public class ProductActivity extends AppCompatActivity {
    ...
    /* renamed from: v1.app.com.codenutrient.Activity.ProductActivity.1 */
    static /* synthetic */ class C03181 {
        public static volatile transient /* synthetic */ IncrementalChange $change;

        C03181(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[0]).hashCode()) {
                case -1968665286:
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[0], Integer.valueOf(((String) objArr[0]).hashCode()), "v1/app/com/codenutrient/Activity/ProductActivity$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C03181 c03181, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "v1/app/com/codenutrient/Activity/ProductActivity$1"}));
            }
        }
    }
    ...
    private class MyTask extends AsyncTask<String, String, Product> {
        ...
        MyTask(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[0]).hashCode()) {
                case -928195726:
                    this((ProductActivity) objArr[1], (C03181) objArr[2]);
                case 696849597:
                case 750636217:
                    this((ProductActivity) objArr[1]);
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[0], Integer.valueOf(((String) objArr[0]).hashCode()), "v1/app/com/codenutrient/Activity/ProductActivity$MyTask"}));
            }
        }

        public static /* synthetic */ Object access$super(MyTask myTask, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                    return super.toString();
                case -2026216808:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "v1/app/com/codenutrient/Activity/ProductActivity$MyTask"}));
            }
        }
        ...
        public Product doInBackground(String... param) {
            ...
            if (incrementalChange != null) {
                return (Product) incrementalChange.access$dispatch("doInBackground.([Ljava/lang/String;)Lv1/app/com/codenutrient/POJO/Product;", this, param);
            }
            ...
            return request.ExecuteGET(this.this$0.code, appUser);
        }

        public void onPostExecute(Product result) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onPostExecute.(Lv1/app/com/codenutrient/POJO/Product;)V", this, result);
                return;
            }
            this.this$0.product = result;
            this.this$0.setData();
        }
        ...
        private MyTask(ProductActivity productActivity) {
            ProductActivity productActivity2;
            IncrementalChange incrementalChange = $change;
            this.this$0 = productActivity;
            if (incrementalChange != null) {
                Object[] objArr = new Object[]{objArr, productActivity};
                Object[] objArr2 = (Object[]) incrementalChange.access$dispatch("init$args.([Ljava/lang/Object;Lv1/app/com/codenutrient/Activity/ProductActivity;)Ljava/lang/Object;", objArr);
                productActivity2 = (ProductActivity) objArr[1];
                this(objArr2, null);
            } else {
                productActivity2 = productActivity;
            }
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lv1/app/com/codenutrient/Activity/ProductActivity$MyTask;Lv1/app/com/codenutrient/Activity/ProductActivity;)V", this, productActivity2);
            }
        }

        public /* synthetic */ MyTask(ProductActivity x0, C03181 x1) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                Object[] objArr = new Object[]{objArr, x0, x1};
                x0 = objArr[1];
                x1 = objArr[2];
                this((Object[]) incrementalChange.access$dispatch("init$args.([Ljava/lang/Object;Lv1/app/com/codenutrient/Activity/ProductActivity;Lv1/app/com/codenutrient/Activity/ProductActivity$1;)Ljava/lang/Object;", objArr), null);
            } else {
                this(x0);
            }
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("init$body.(Lv1/app/com/codenutrient/Activity/ProductActivity$MyTask;Lv1/app/com/codenutrient/Activity/ProductActivity;Lv1/app/com/codenutrient/Activity/ProductActivity$1;)V", this, x0, x1);
            }
        }
    }

    ProductActivity(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[0]).hashCode()) {
            case -2089128195:
            case 638651888:
                this();
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[0], Integer.valueOf(((String) objArr[0]).hashCode()), "v1/app/com/codenutrient/Activity/ProductActivity"}));
        }
    }

    public static /* synthetic */ Object access$super(ProductActivity productActivity, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
            ...
            case -1554832987:
                ...
                return null;
            case -1552004352:
                super.requestPermissionsFromFragment((Fragment) objArr[0], (String[]) objArr[1], ((Number) objArr[2]).intValue());
                return null;
            case -1545899961:
            ...
            case 1354010372:
                ...
                return null;
            case 1357142347:
                super.startIntentSenderFromFragment((Fragment) objArr[0], (IntentSender) objArr[1], ((Number) objArr[2]).intValue(), (Intent) objArr[3], ((Number) objArr[4]).intValue(), ((Number) objArr[5]).intValue(), ((Number) objArr[6]).intValue(), (Bundle) objArr[7]);
                return null;
            case 1391904137:
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "v1/app/com/codenutrient/Activity/ProductActivity"}));
        }
    }
    ...
    public void onCreate(Bundle savedInstance) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("onCreate.(Landroid/os/Bundle;)V", this, savedInstance);
            return;
        }
        super.onCreate(savedInstance);
        setContentView((int) C0321R.layout.activity_product);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        this.manager = new HttpManager();
        this.code = getIntent().getStringExtra("code");
        this.fm = getFragmentManager();
        this.fragment = (Product_i) this.fm.findFragmentById(C0321R.id.product_iz);
    ...
    public boolean reload() {
        ...
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Boolean) incrementalChange.access$dispatch("reload.()Z", this)).booleanValue();
        }
        this.reload++;
        if (this.reload != 1) {
            return false;
        ...
        try {
            new ReloadUser().postExecute((AppUser) userRequests.execute(new AppUser[]{MainActivity.appUser}).get(), getApplicationContext());
    ...
    public void setData() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("setData.()V", this);
            return;
        }
        switch (this.product.getCode()) {
            case ConnectionResult.SUCCESS /*0*/:
                Toast.makeText(getApplicationContext(), "Error del servidor", 0).show();
            case ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION /*200*/:
                this.fragment.setData(this.product, this);
                this.fm.beginTransaction().setCustomAnimations(17498113, 17498112).show(this.fragment).commit();
            case 401:
                if (!this.manager.isOnLine(getApplicationContext())) {
                    Toast.makeText(getApplicationContext(), "No estas conectado a internet", 0).show();
                    finish();
    ...
    public ProductActivity() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lv1/app/com/codenutrient/Activity/ProductActivity;)V", this);
            return;
        }
        this.product = null;
        this.reload = 0;
